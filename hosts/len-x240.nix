...

{
  ...
  imports =
    [
      ../modules/drivers_CPU_intel_pre10.nix                                           # optionnel - intégrable sous conditions (CPU AMD)
      ../modules/drivers_iGPU_intel.nix                                                # optionnel - intégrable sous conditions (GPU AMD)
      ...
      ../modules/pseudo_impermanence.nix                                               # optionnel - intégrable sous conditions (variables.nix ou adaptation manuelle)
