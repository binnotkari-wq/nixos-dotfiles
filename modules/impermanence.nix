...

{
  ...
  # Cette configuration de système de fichier est créée par bootstrap.sh mais pas par Calamares, qui ne créé pas de sous-solume distinct pour root, et qui nomme le volume LUKS d'après son UUID.
  boot.initrd.systemd = {
   services.erase_root = {
